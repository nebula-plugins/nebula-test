...
class GradleRunnerSpec extends Specification {
    ...
    def setup() {
        ...
        new File(userDir, 'build/classes/test/').toURI() as String,
        new File(userDir, 'build/classes/main/').toURI() as String,
        new File(userDir, 'build/resources/test/').toURI() as String,
        new File(userDir, 'build/resources/main/').toURI() as String,
